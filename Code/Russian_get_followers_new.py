...
user_cursor = set()
for line in open("../Datasets/russian_errors_new.txt"):
...
FollowGraph = dict()
outfile = "../Datasets/russian_adjList_new2.txt"
errorfile = "../Datasets/russian_errors_new2.txt"
    ...
    while cursor != 0:
        ...
        try:
            ...
            if calls_remaining == 0:
                time_to_wait = 15*60 + 10 # add 10 seconds just in case
                start = time.time()
                elapsed_time = 0
